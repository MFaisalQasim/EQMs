...
Route::get('/new-audits', 'PagesController@NewAudits');
Route::get('/past-audits', 'PagesController@PastAudits');
Route::get('/pending-audits', 'PagesController@PendingAudits');
Route::get('/training_calender', 'PagesController@TrainingCalender');
Route::get('/users-of-userb', 'PagesController@ViewEmployee');


Route::group(['middleware' => ['auth', 'roles'],'roles' => ['User A','User B','Developer','UserC1','UserC2']], function () {
...
Route::group(['middleware' => ['auth', 'roles'],'roles' => 'User A','roles' => 'User B','roles'=>'Developer'], function () {
// Route::group(['middleware' => ['auth', 'roles'],'roles' => 'admin'], function () {
    ...
    Route::get('users/userb', 'UsersController@getIndex');
...
Auth::routes();
Route::resource('Documents/documents', 'DocumentsController\\DocumentsController');
Route::resource('personalRecords/personal-records', 'personalRecordsController\\personalRecordsController');
Route::get('job-positions/job-positions', 'personalRecordsController\\personalRecordsController@index2');
Route::resource('motivationalquotes/motivational-quotes', 'MotivationalQuotes\\MotivationalQuotesController');
...
Route::resource('emergency-response-exercise/emergency-response-exercise', 'EmergencyResponseExercise\\EmergencyResponseExerciseController');

Route::resource('management-review/management-review', 'ManagementReviewController\\ManagementReviewController');


Route::resource('Test/test', 'TestController\\TestController');
...
Route::resource('add_training/add-training', 'AddTrainingController\\AddTrainingController');
Route::resource('external-audit', 'ExternalAuditController\\ExternalAuditController');
Route::resource('job-position', 'JobPositionController\\JobPositionController');
