    ...
    <div class="scroll-sidebar">
        ...
        @if (auth()->check())
                    ...
                    <div class="dropdown user-pro-body ">
                        <div class="profile-image">
                            ...
                            <ul class="dropdown-menu animated flipInY">
                                ...
                                <li><a href="{{ 'account-settings' }}"><i class="fa fa-cog"></i> Account
                                        Settings</a></li>
                                <li role="separator" class="divider"></li>
            ...
            <nav class="sidebar-nav">
                <ul id="side-menu">
                    <li>
                        <a class="active waves-effect" href="{{ url('/') }}" aria-expanded="false"><i
                                class="icon-screen-desktop fa-fw"></i> <span class="hide-menu"> Dashboard
                            </span></a>
                    </li>
                    ...
                    @if (auth()->user()->hasRole('Developer'))
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse extra">
                                ...
                                <li>
                                    <a href="{{ asset('widgets') }}" aria-expanded="false"><span class="hide-menu">
                                            Widgets
                                        </span></a>
                                </li>
                                <li>
        ...
        @else
            ...
            <div class="list-group">
                ...
                @if (count($tags) > 0)
                    @foreach ($tags as $tag)
                        <a class="list-group-item"
                            href="{{ url('blogs/tag/' . $tag->slug) }}">{{ $tag->name }}</a>
                    @endforeach
                @else
                    No Categories Yet
                @endif
