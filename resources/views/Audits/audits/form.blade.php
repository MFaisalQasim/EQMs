...
{{-- <div class="form-group {{ $errors->has('audit_timing') ? 'has-error' : '' }}">
    {!! Form::label('audit_timing', 'Audit Timing', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::date(
            'audit_timing',
            null,
        ...
        {!! $errors->first('audit_timing', '<p class="help-block">:message</p>') !!}
    </div>
</div> --}}
