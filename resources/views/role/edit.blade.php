                            ...
                            <form class="form-horizontal" method="post" action="{{url('role/edit/'.$role->id)}}">
                                        ...
                                        @foreach($section->items as $key=>$menu)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <input @if(in_array($permissions['view'],$role_permissions)) checked @endif type="checkbox" class="view" name="permissions[]"
                                                           value="{{$permissions['view']}}">
                                                </td>
                                                <td class="text-center">
                                                    <input @if(in_array($permissions['add'],$role_permissions)) checked @endif type="checkbox" class="add" name="permissions[]"
                                                           value="{{$permissions['add']}}">
                                                </td>
                                                <td class="text-center">
                                                    <input @if(in_array($permissions['edit'],$role_permissions)) checked @endif type="checkbox" class="edit" name="permissions[]"
                                                           value="{{$permissions['edit']}}">
                                                </td>
                                                <td class="text-center">
                                                    <input @if(in_array($permissions['delete'],$role_permissions)) checked @endif type="checkbox" class="delete" name="permissions[]"
                                ...
                                @endforeach
                                    {{-- <tr>
                                        ...
                                        <td class="text-center">
                                            <input @if(in_array($blog_permissions['view'],$role_permissions)) checked @endif type="checkbox" class="view" name="permissions[]"
                                                   value="{{$blog_permissions['view']}}">
                                        </td>
                                        <td class="text-center">
                                            <input @if(in_array($blog_permissions['add'],$role_permissions)) checked @endif type="checkbox" class="add" name="permissions[]"
                                                   value="{{$blog_permissions['add']}}">
                                        </td>
                                        <td class="text-center">
                                            <input @if(in_array($blog_permissions['edit'],$role_permissions)) checked @endif type="checkbox" class="edit" name="permissions[]"
                                                   value="{{$blog_permissions['edit']}}">
                                        </td>
                                        <td class="text-center">
                                            <input @if(in_array($blog_permissions['delete'],$role_permissions)) checked @endif type="checkbox" class="delete" name="permissions[]"
